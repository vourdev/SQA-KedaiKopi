...
WebUI.navigateToUrl('https://pos.bling.my.id/admin/menu')

WebUI.setText(findTestObject('Page_Menu/Menu-manual/Page_KedaiKopi  Menu Management/input_Menu Management_filetext-foreground placeholdertext-muted-foreground selectionbg-primary selectiontext-primary-foreground darkbg-input30 border-input flex h-9 w-full min-w-0 rounded-md border bg-transparent px-3 py'), 
    'chuangki')
