...
WebUI.click(findTestObject('Page_Menu/update-menu/a_Menu'))

WebUI.click(findTestObject('Page_Menu/update-menu/button_detail'))

WebUI.click(findTestObject('Page_Menu/update-menu/div_Edit'))

WebUI.setText(findTestObject('Page_Menu/update-menu/input_Insert name here'), 'Es Kopi Susu Gula Aren Mangga')

WebUI.click(findTestObject('Page_Menu/update-menu/button_Update'))
