...
WebUI.setText(findTestObject('Page_Menu/Search/Page_KedaiKopi  Login/input_Username'), 'vour@gmail.com')
...
WebUI.click(findTestObject('Page_Menu/Order-Checkout/Manual-Order-Checkout-SPY/div_Testing Meja - available (10)'))

WebUI.click(findTestObject('Page_Menu/Order-Menu/button_Select Status (1)'))

WebUI.click(findTestObject('Page_Menu/Order-Checkout/Manual-Order-Checkout-SPY/div_Process'))
...
WebUI.click(findTestObject('Page_Menu/Order-Checkout/Manual-Scheckout-SPY-v2/button_action_add'))

WebUI.click(findTestObject('Page_Menu/Order-Checkout/Manual-Scheckout-SPY-v2/a_Detail_manajement'))
